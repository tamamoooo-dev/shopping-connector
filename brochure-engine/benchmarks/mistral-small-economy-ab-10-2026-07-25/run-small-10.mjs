// mistral-small-latest over the 10 selected frozen crops.
//
...
const RESULTS_PATH = join(HERE, 'small-results.json');
...
const frozen = await loadJson(join(HERE, 'sample-10.json'));
